 ...
 *
 * @apiSuccess (Request Elements) {String} CommonPrefixes 根据delimiter分组的各组
 * @apiSuccess (Request Elements) {String} IsTruncated Objects列表是否截断
 * @apiSuccess (Request Elements) {String} Marker 标记返回的Objects list从哪里开始
 * @apiSuccess (Request Elements) {String} NextMarker 如果返回列表被截断，该字段说明是从哪里截断
 * @apiSuccess (Request Elements) {String} Prefix 返回列表所用的prefix
 *
